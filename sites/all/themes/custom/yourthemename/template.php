...
function yourthemename_preprocess_html(&$vars) {
  ...
  $sidebar_layout = theme_get_setting('sidebar_layout', 'yourthemename');
  if($sidebar_layout == 'left_sidebar') {
    $vars['classes_array'][] = 'left-sidebar';
  }
  $sidebar_width = theme_get_setting('sidebar_width', 'yourthemename');
...
if (drupal_is_front_page()) {
  drupal_add_js(drupal_get_path('theme', 'yourthemename') . '/js/jquery.cycle.all.min.js');
  drupal_add_js(drupal_get_path('theme', 'yourthemename') . '/js/slide.js');
}
